...
String CHECK_MED_ITEMS_DRONE_NUMBER_WRONG_LENGTH = "checking Drone Number length";
String CHECK_MED_ITEMS_MISSIMG_DRONE_NUMBER = "checking Missing Drone Number";
